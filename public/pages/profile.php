...
?>
    <div id="alertMessage" class="fixed top-4 right-4 z-[100] bg-white border-l-4 <?php echo $msg_class; ?> px-6 py-4 rounded shadow-lg flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-300">
